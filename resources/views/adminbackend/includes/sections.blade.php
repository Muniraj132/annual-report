...
<script>
 ...
 // sub section Positionset
    ...
    $("#column-ar").click(function () {
        ...
        $("#ColumnAddRemove").append('<tr><td><input type="text" name="PagesectionColumn[]" value="'+data+'" placeholder="Enter Column Name" class="form-control" /></td><td><button type="button" class="btn btn-outline-danger remove-input-field">Delete</button></td></tr>');
    });
